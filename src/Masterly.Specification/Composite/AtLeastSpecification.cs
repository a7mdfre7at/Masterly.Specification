...
{
    /// <summary>
    /// Represents a specification where AT LEAST N of the given specifications must be satisfied.
    /// </summary>
    ...
    public class AtLeastSpecification<T> : Specification<T>
    {
        ...
        public AtLeastSpecification(int count, params ISpecification<T>[] specifications)
            : this(count, (IEnumerable<ISpecification<T>>)specifications)
        {
        }

        public AtLeastSpecification(int count, IEnumerable<ISpecification<T>> specifications)
        {
        ...
        public override Expression<Func<T, bool>> ToExpression()
        {
            ...
            BinaryExpression comparison = Expression.GreaterThanOrEqual(countExpr, Expression.Constant(_count));
